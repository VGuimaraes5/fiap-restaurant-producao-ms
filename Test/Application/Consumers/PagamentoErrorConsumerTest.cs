...
{
    public class PagamentoErrorConsumerTests
    {
        [Fact]
        public void Consume_ProcessesMessageAndCallsExecuteAsync()
        {
            ...
            var consumer = new PagamentoErrorConsumer(mockServiceScopeFactory.Object, mockConfiguration.Object);
            ...
            // Assert
            var expectedStatusRequest = new PedidoAlteraStatusRequest { PedidoId = data.PedidoId, Status = (short)Status.Reprovado };
            var expectedStatusPagamentoRequest = new PedidoAlteraStatusPagamentoRequest { PedidoId = data.PedidoId, Status = (short)StatusPagamento.Reprovado };
